...
function loadLevel () {
    if (currentLevel == 0) {
        ...
        game.gameOver(true)
        game.setGameOverMessage(true, "You Won! Press A to play again.")
        startFunction()
    }
}
...
function spawnEnemy () {
    for (let value of tiles.getTilesByType(assets.tile`myTile2`)) {
        badguy = sprites.create(img`
            ...
            ........................
            `, SpriteKind.Enemy)
        badguy.setVelocity(60, 0)
        badguy.setBounceOnWall(true)
        tiles.placeOnTile(badguy, value)
        tiles.setTileAt(value, assets.tile`transparency16`)
        animation.runImageAnimation(
        badguy,
        [img`
...
function startFunction () {
    game.splash("Press A to start the game.")
    info.setLife(3)
    info.setScore(0)
    Gravity = 500
    max_jumps = 2
